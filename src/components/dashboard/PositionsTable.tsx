        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-border bg-muted/20 text-[9px] sm:text-[10px] text-muted-foreground uppercase tracking-widest">
              ...
              <th className="hidden lg:table-cell p-2 sm:p-4 font-normal text-right whitespace-nowrap">Fees</th>
              <th className="hidden lg:table-cell p-2 sm:p-4 font-normal text-right whitespace-nowrap">Realized</th>
              <th className="p-2 sm:p-4 font-normal text-right whitespace-nowrap">Unrealized PnL</th>
          ...
          <tbody className="text-xs font-mono divide-y divide-border">
            {positions.map((position) => (
              ...
              >
                ...
                <td className="hidden lg:table-cell p-2 sm:p-4 text-right text-muted-foreground text-xs">{position.fees.toFixed(4)}</td>
                <td className="hidden lg:table-cell p-2 sm:p-4 text-right text-xs">
                  <span className={position.realized >= 0 ? "text-pnl-gain" : "text-accent-pink"}>{position.realized.toFixed(2)}</span>
                </td>
